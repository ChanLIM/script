...
VER=$(echo "$Id: cfg2html-linux,v 2.66 2013-02-09 10:24:37 ralph Exp $"|awk '{print $3"-"$4;}')
if [ -z "$VER" ]        # no awk, e.g. my Linux router // OpenWRT
then
    VER="$Revision: 2.66 $";
fi;
VERSION="cfg2html-linux version $VER "  # this a common stream so we dont need the "Proliant stuff"
...
<HTML> <HEAD>
 ...
 <META NAME="DESCRIPTION" CONTENT="$Header: /home/cvs/cfg2html/cfg2html_linux/cfg2html-linux,v 2.66 2013-02-09 10:24:37 ralph Exp $">
...
echo -e "(c) 1998- 2013 by ROSE SWE, Ralph Roth" >> $TEXT_OUTFILE
}
